  ...
  return (
    <div className="flex flex-col items-center gap-8 w-full">
            ...
            <div className="flex flex-col items-center gap-3">
                <div className="w-16 h-16 bg-whatsapp-green rounded-full flex items-center justify-center text-white shadow-lg relative">
                    ...
                    <div className="absolute -bottom-1 -right-1 bg-white rounded-full p-1 text-whatsapp-green shadow-sm border border-whatsapp-green/20">
                        {localStream ? <Mic size={40} /> : <MicOff size={40} className="text-red-500" />}
                    </div>
                </div>
                <span className="text-3xl font-black uppercase tracking-widest opacity-100">You</span>
            </div>
        ...
        <button
            ...
            className={`px-10 py-5 rounded-full flex items-center gap-3 font-black transition-all uppercase tracking-[0.3em] text-3xl shadow-2xl ${
                localStream
                ? 'bg-red-500 text-white hover:bg-red-600'
                : 'bg-whatsapp-green text-white hover:bg-whatsapp-darkGreen'
            }`}
        >
            {localStream ? <MicOff size={32} /> : <Mic size={32} />}
